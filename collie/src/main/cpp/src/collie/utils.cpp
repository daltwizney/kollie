...
void checkThread() {
    ...
    __android_log_print(ANDROID_LOG_DEBUG, "CollieLog", "Thread ID: %lu", tid);
}

__attribute__((constructor))
void onLibraryLoad() {
    __android_log_print(ANDROID_LOG_DEBUG, "CollieLog", "Library loaded.");
}

__attribute__((destructor))
void onLibraryUnload() {
    __android_log_print(ANDROID_LOG_DEBUG, "CollieLog", "Library UNLOADED!");
}
